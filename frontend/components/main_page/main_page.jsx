                              ...
                              <div className="main-desc7">
                                <div className="main-desc8">
                                  <div className="main-desc9">
                                    On Platereon, you can let your fans become active participants 
                                    in the food they love by offering them a monthly membership. 
                                    You give them access to exclusive content, community, and 
                                    insight into your culinary process. In exchange, you get the 
                                    freedom to create your most delicious meals, and the stability 
                                    you need to build an independent creative career.
                                  </div>
                                </div>
                              </div>
                            </div>
